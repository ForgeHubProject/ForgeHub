      ...
      <div className="card p-4 mb-6">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="text-gh-muted flex-shrink-0">
            <path fillRule="evenodd" d="M7.78 12.03a.75.75 0 01-1.06 0L2.47 7.78a.75.75 0 010-1.06l4.25-4.25a.75.75 0 011.06 1.06L4.81 6.5h7.44a.75.75 0 010 1.5H4.81l2.97 2.97a.75.75 0 010 1.06z" />
          </svg>
          <div className="flex items-center gap-2">
